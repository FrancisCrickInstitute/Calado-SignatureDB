...
Details regarding where and how each signature is obtained can be found in the Excel Sheet [here](releases/v0.0.4/index.xlsx).

## Data Availability
Data is available on both [DropBox](https://www.dropbox.com/scl/fo/s8c1slvqsb4vgvtt8kyze/ALm1fkTMvmk3M4wYkKN1AVY?rlkey=eatreddt37xe9mqknw9dm321a&st=o09cb0zc&dl=0) and NEMO at `/nemo/lab/caladod/working/Shared/Calado-SignatureDB`.
